...
| Platform | Download |
|----------|----------|
| Windows (x64) | [birdweatherviz3-windows-x64.zip](https://github.com/lostculture/BirdWeatherViz3/releases/download/v2.3.0/birdweatherviz3-windows-x64.zip) |
| macOS (Apple Silicon — M1/M2/M3/M4) | [birdweatherviz3-macos-arm64.tar.gz](https://github.com/lostculture/BirdWeatherViz3/releases/download/v2.3.0/birdweatherviz3-macos-arm64.tar.gz) |
| macOS (Intel) | [birdweatherviz3-macos-x64.tar.gz](https://github.com/lostculture/BirdWeatherViz3/releases/download/v2.3.0/birdweatherviz3-macos-x64.tar.gz) |
| Linux (x64) | [birdweatherviz3-linux-x64.tar.gz](https://github.com/lostculture/BirdWeatherViz3/releases/download/v2.3.0/birdweatherviz3-linux-x64.tar.gz) |
