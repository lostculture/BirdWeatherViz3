...
# Version history
VERSION_HISTORY = {
    "2.3.0": "Analytics rollups for multi-million-detection databases (fixes the 30s Analytics timeout); per-chart loading; new Nocturnal page for bats, owls and nightjars; Dusk Chorus plot; returning and overdue species; searchable species picker; seasonality plot gaps and repeating x-axis; issues #22/#24/#25; dependency refresh (React 19, Tailwind 4, Vite 8, TypeScript 7, plotly 4)",  # 2026-09-10
    "2.2.2": "Hide Sync All button for unauthenticated visitors; auto-sync-on-load skips silently when no token. Backend scheduler keeps data fresh.",  # 2026-04-27
